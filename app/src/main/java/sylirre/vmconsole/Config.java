...
public class Config {
     ...
     */
    public static final int QEMU_MAX_SAFE_RAM = 4096;
     ...
     * degradation.
     */
    public static final int QEMU_MIN_TCG_BUF = 512;

    /**
     * Maximal size in MiB of TCG buffer to prevent wasting of device
     * memory by keeping unnecessary code caches.
     */
    public static final int QEMU_MAX_TCG_BUF = 1024;

    /**
     * A tag used for general logging.
     */
    public static final String APP_LOG_TAG = "vmconsole:app";

    /**
     * A tag used for input (ime) logging.
     */
    public static final String INPUT_LOG_TAG = "vmconsole:input";

    /**
     * A tag used for installer logging.
     */
    public static final String INSTALLER_LOG_TAG = "vmconsole:installer";

    /**
     * A tag used for wakelock logging.
     */
    public static final String WAKELOCK_LOG_TAG = "vmconsole:wakelock";
