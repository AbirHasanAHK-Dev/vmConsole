...
set -eu
TARGET="${1:-/mnt}"
CMDLINE="nomodeset vga=normal console=tty0 console=ttyS0,115200n8 panic=30"
...
touch "$INITTAB"
grep -q '^ttyS0::respawn:/sbin/getty' "$INITTAB" || echo 'ttyS0::respawn:/sbin/getty -L ttyS0 115200 vt100' >> "$INITTAB"
